...
class DataPreprocess:
    ...
    def __init__(self, data, do_load_existing_tokenizer=True):
        ...
        emoji_embeddings_filename = "../model/emoji_embeddings_%dd.txt" % EMBEDDING_DIMENSION
        emoji2vec = utils.load_vectors(filename=emoji_embeddings_filename)
        ...
        print('Splitting the data into the labels...')
        ...
        for word, i in word_to_index.items():
            if i < MAX_VOCAB_SIZE: 
                ...
                if embedding_vector is None:
                    print('Cannot find word in GloVe, using emoji2vec...')
                    embedding_vector=emoji2vec.get(word)
